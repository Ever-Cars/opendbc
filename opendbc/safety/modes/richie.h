...
static bool richie_tx_hook(const CANPacket_t *msg) {
  ...
  if ((msg->addr != 0x18DB33F1U) && ((msg->addr & 0x1FFF00FFU) != 0x18DA00F1U) &&
      ((msg->addr & 0x1FFF00FFU) != 0x17FC0076U) && ((msg->addr & 0x1FFF00FFU) != 0x18DA00F1U) &&
      ((msg->addr & 0x1FFFFF00U) != 0x600U) && ((msg->addr & 0x1FFFFF00U) != 0x700U) &&
      (msg->addr != GM_CAMERA_DIAG_ADDR) && ((msg->addr & 0x1FFF00FFU) != 0x1DD00001U)) {
    tx = false;
  }
